...
\author{Pedro Pillon Vanzella\inst{1}}
...
\begin{resumo} 
  Este artigo mostrará uma análise de diferentes métodos para processamento de imagens, dum ponto de vista de Computação Científica. O objetivo é escolher o melhor método para trabalhar com texturas em um jogo 3D. Para este fim, serão analisados métodos para redimensionar e rotacionar imagens.
\end{resumo}
